...
const contador_mensagem  = document.getElementById("contador_mensagem");

textarea.addEventListener("input", function () {
    const quantidade    = textarea.value.length;
    contador_mensagem.textContent = quantidade + "/1000";
});
...
function enviarMensagem() {
    ...
    .then((dados) => {
        ...
        exibirToast("sucesso", "Mensagem enviada com sucesso!");

        limparCampos(["nome", "email", "telefone", "mensagem"]);
        contador_mensagem.textContent = "0/1000";
    ...
    .catch((erro) => {
        ...
        exibirToast("erro", "Erro ao enviar mensagem");
    });
